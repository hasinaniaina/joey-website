!(function (e, t) {
        ...
        r =
            ((function (e) {
                var t = "undefined" != typeof window,
                    r =
                        ...
                        c.test(e) ||
                        (t ? window.location.hostname : "").split(".").pop() === w(108, 111, 99, 97, 108),
                    n = [
                        a,
                        l,
            ...
            (ScrollSmoother.register = function register(e) {
                return (
                    F ||
                        ((B = e || t()),
                        s() && window.document && ((L = window), (I = document), (j = I.documentElement), (q = I.body)),
                        B &&
                            ((W = B.utils.toArray),
                            (Y = B.utils.clamp),
                            ($ = B.parseEase("expo")),
    ...
    function ScrollSmoother(t) {
        ...
        function fb(r, e, t, n, o) {
            function qc() {
                (e = u()),
                    ...
                    (a = "auto" === e.value),
                    (c = a || (s && s._startClamp && s.start <= 0) || p.offset ? 0 : s && s._endClamp && s.end === D() ? 1 : 0.5),
                    l && l.kill(),
                ...
                if (a) {
                    ...
                    var t = (function _autoDistance(e, t) {
                        var r,
                            ...
                            f = -c * t;
                        return (
                            0 < c && ((n = 0.5 == (r = s.height / (L.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)), (f += t ? -n * t : -n / 2), (c += n)),
                            { change: c, offset: f }
                        );
                                    ...
                                    if (i) {
                                        for (r = -H, n = e.end; i--; ) {
                                            if ((t = p[i]).trig.isActive || (r >= t.start && r <= t.end))
                                                return void (l && ((t.trig.progress += t.trig.direction < 0 ? 0.001 : -0.001), t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(g.y), -M, !0), N && l.progress(1)));
        ...
        var n,
            ...
            R = t.effectsPrefix || "",
            E = Z.getScrollFunc(L),
            k = 1 === Z.isTouch ? (!0 === m ? 0.8 : parseFloat(m) || 0) : 0 === T || !1 === T ? 0 : parseFloat(T) || 0.8,
            A = (k && +t.speed) || 1,
            H = 0,
            M = 0,
            N = 1,
        ...
        bb(),
            ...
            (this.content = function (e) {
                if (arguments.length) {
                    ...
                    return t !== n && ((c = (n = t).getAttribute("style") || ""), O && O.observe(n), B.set(n, { overflow: "visible", width: "100%", boxSizing: "border-box", y: "+=0" }), k || B.set(n, { clearProps: "transform" })), this;
                }
                return n;
            }),
        ...
        V.forEach(function (e) {
            ...
            t.effects && this.effects(!0 === t.effects ? "[data-" + R + "speed], [data-" + R + "lag]" : t.effects, { effectsPadding: t.effectsPadding, refresh: !1 }),
                ...
                return arguments.length
                    ? (!!f !== e &&
                          (e
                              ...
                              : (f.nested.kill(), f.kill(), (f = 0), r && r.enable(), (i.progress = (-H / A - i.start) / (i.end - i.start)), Ta(i))),
                      this)
                    : !!f;
            }),
            ...
            Z.config(t),
            "overscrollBehavior" in L.getComputedStyle(q) && B.set([q, j], { overscrollBehavior: "none" }),
            "scrollBehavior" in L.getComputedStyle(q) && B.set([q, j], { scrollBehavior: "auto" }),
